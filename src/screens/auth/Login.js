  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.heading}>
        <Text style={{ fontFamily: "Mulish", fontSize: 27, fontWeight: 'bold', letterSpacing: 1, color: "#000" }}>Hello!</Text>
        <Text style={{ fontFamily: "Mulish", fontSize: 12, fontWeight: 500, letterSpacing: 1, color: "#707B81" }}>Welcome Back You’ve Been Missed!</Text>
      </View>

      <View>
        <View>
          <Text style={styles.text}>Email</Text>
          <TextInput placeholder='Enter Your Email' style={styles.input} placeholderTextColor={"#000"} />
        </View>
        <View>

          <Text style={styles.text_1}>Password</Text>
          <TextInput placeholder='Enter Your Password' style={styles.input_1} secureTextEntry={true} placeholderTextColor={"#000"} />
        </View>
